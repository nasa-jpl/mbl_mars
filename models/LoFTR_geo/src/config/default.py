...
# Enable the ONNX changes to the model
_CN.LOFTR.ONNX = False

# Contrastive learning options
_CN.LOFTR.CONTRASTIVE = False # enable/disable
_CN.LOFTR.LOSS.CONTRASTIVE_WEIGHT = 1.0
...
# MegaDepth options
_CN.DATASET.MGDPT_IMG_RESIZE = True #640  # resize the longer side, zero-pad bottom-right to square.
...
# Added by Georgios
_CN.TRAINER.PRETRAINED_MODEL_WEIGHTS = None
_CN.TRAINER.CUT_IDX = 20 # Number of files to keep for validation from each folder
_CN.DATASET.DILATION_KERNEL_SIZE = 5 # Kernel size for dilation if shadow masks are part of the dataset
