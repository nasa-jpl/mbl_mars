from models.LoFTR.configs.data.base import cfg


#TRAIN_BASE_PATH = "data/megadepth/index"
#cfg.DATASET.TRAINVAL_DATA_SOURCE = "MegaDepth"
cfg.DATASET.TRAIN_DATA_ROOT = "data/jezero_HiRISE/texture_resolution_A/training_pairs/" #"data/jezero_1sample/training_pairs/" #  #   #   #"data/megadepth/train"
#cfg.DATASET.TRAIN_DATA_ROOT = "/work/09530/georgakis/ls6/loftr_train/data/canyon_A/training_pairs/"
...
# Number of files to keep for validation from each folder
cfg.TRAINER.CUT_IDX = 50 #50 #1 #100 #20

cfg.DATASET.MGDPT_IMG_RESIZE = True
