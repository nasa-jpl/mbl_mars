...
cfg.DATASET.TRAIN_DATA_ROOT = "data/south_pole_LDEMs/training_pairs/" #"data/megadepth/train"
#cfg.DATASET.TRAIN_DATA_ROOT = "/work/09530/georgakis/ls6/loftr_train/data/south_pole_LDEMs/training_pairs/"
...
cfg.TRAINER.CUT_IDX = 5 #20

cfg.DATASET.MGDPT_IMG_RESIZE = True
cfg.DATASET.DILATION_KERNEL_SIZE = 5
